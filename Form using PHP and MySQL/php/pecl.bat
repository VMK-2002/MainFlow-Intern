...
FOR %%x IN ("C:\Users\Veeramanikandan\OneDrive\Desktop\VMK\Projects\MainFlow-Intern\Form using PHP and MySQL\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\Veeramanikandan\OneDrive\Desktop\VMK\Projects\MainFlow-Intern\Form using PHP and MySQL\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\Veeramanikandan\OneDrive\Desktop\VMK\Projects\MainFlow-Intern\Form using PHP and MySQL\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\Veeramanikandan\OneDrive\Desktop\VMK\Projects\MainFlow-Intern\Form using PHP and MySQL\php\php.exe"
GOTO :INSTALLED
